...
// add a datepicker for the dates
$("#modalDueDate").datepicker({
  // prevent users from picking dates in the past
  minDate: 1
});

// AUDIT TASK - add highlighting to tasks that are approaching or over their due dates
...
// stop editing the text and save it when user clicks outside of the text box
$(".list-group").on("blur", "textarea", function() {
  ...
  // update the text of the to-do object of the status and index of the box we edited with the new text
